        ...
        >
          <div className="space-y-5 text-center sm:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center">
              ...
              {/* Right Section */}
              <div className="flex-1 sm:pl-4 space-y-10">
                <div>
                  <span className="text-thRed font-bold uppercase block">
                    Reliable Solutions
                  </span>
                  <p className="text-sm sm:text-base">
                    Our company’s dedication to consistently offer dependable
                    and effective responses to our clients’ needs, cultivating
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base">
                    ...
                    field, enabling us to maintain a competitive edge and
